...
nav.classList.add("navbar","navbar-expand-ld","navbar-dark","bg-dark");
...
let getpokemon = async  id=>{
   ...
   row.innerHTML+=`
      <div class="col-lg-6 col-sm-14 ">
        <div class="card border-success mb-3" style="max-width: 20rem; margin:80px 30px;">
           <div class="card-header text-dark" id="pokemonName" style="text-align:center; font-size:20px;"><head>Name :${res1.species.name}</head></div>
